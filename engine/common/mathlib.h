...
typedef float vec_t;
typedef vec_t FTE_ALIGN(sizeof(vec_t) * 2) vec2_t[2];
typedef vec_t vec3_t[3];
typedef vec_t FTE_ALIGN(sizeof(vec_t) * 4) vec4_t[4];
typedef vec_t quat_t[4];
typedef vec_t vec5_t[5];
typedef vec_t vec6_t[6];
typedef vec_t vec7_t[7];
typedef vec_t FTE_ALIGN(sizeof(vec_t) * 8) vec8_t[8];

typedef int ivec_t;
typedef ivec_t  FTE_ALIGN(sizeof(ivec_t) * 2) ivec2_t[2];
typedef ivec_t  ivec3_t[3];
typedef ivec_t  FTE_ALIGN(sizeof(ivec_t) * 4) ivec4_t[4];
typedef ivec4_t iquat_t[4];
typedef ivec_t  ivec5_t[5];
typedef ivec_t  ivec6_t[6];
typedef ivec_t  ivec7_t[7];
typedef ivec_t  FTE_ALIGN(sizeof(ivec_t) * 8) ivec8_t[8];

typedef FTE_ALIGN(4)  qbyte byte_vec4_t[4];
typedef FTE_ALIGN(8)  qbyte byte_vec8_t[8];
typedef FTE_ALIGN(16) qbyte byte_vec16_t[16];
typedef FTE_ALIGN(32) qbyte byte_vec32_t[32];
typedef FTE_ALIGN(64) qbyte byte_vec64_t[64];

typedef                              vec2_t avec2_t;
typedef FTE_ALIGN(sizeof(vec_t) * 4) vec3_t avec3_t;
typedef                              vec4_t avec4_t;
typedef                              vec4_t aquat_t;
typedef FTE_ALIGN(sizeof(vec_t) * 8) vec5_t avec5_t;
typedef FTE_ALIGN(sizeof(vec_t) * 8) vec6_t avec6_t;
typedef FTE_ALIGN(sizeof(vec_t) * 8) vec7_t avec7_t;
typedef                              vec8_t avec8_t;

typedef                              ivec2_t aivec2_t;
typedef FTE_ALIGN(sizeof(vec_t) * 4) ivec3_t aivec3_t;
typedef                              ivec4_t aivec4_t;
typedef                              ivec4_t aiquat_t;
typedef FTE_ALIGN(sizeof(vec_t) * 8) ivec5_t aivec5_t;
typedef FTE_ALIGN(sizeof(vec_t) * 8) ivec6_t aivec6_t;
typedef FTE_ALIGN(sizeof(vec_t) * 8) ivec7_t aivec7_t;
typedef                              ivec8_t aivec8_t;
...
typedef vec_t FTE_ALIGN(sizeof(vec_t) * 2 * 2)   mat2_t[2 * 2];
typedef vec3_t                                   mat3_t[3];
typedef vec3_t                                   mat43_t[4];
typedef vec4_t                                   mat34_t[3];
typedef FTE_ALIGN(sizeof(vec_t) * 4 * 4) vec4_t  mat4_t[4];
typedef FTE_ALIGN(sizeof(vec_t) * 8 * 8) vec8_t  mat8_t[8];
typedef vec_t FTE_ALIGN(sizeof(vec_t) * 2 * 2)   matrix2x2[2][2];
typedef vec_t matrix3x4[3][4];
typedef vec_t matrix3x3[3][3];
typedef vec_t FTE_ALIGN(sizeof(vec_t) * 4 * 4)   matrix4x4[4][4];
typedef vec_t FTE_ALIGN(sizeof(vec_t) * 8 * 8)   matrix8x8[8][8];
