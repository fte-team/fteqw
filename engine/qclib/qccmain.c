...
compiler_flag_t compiler_flag[] = {
	...
	{&flag_poundonly,		FLAG_MIDCOMPILE,"poundonly",	"Pound-only constants", "Allows use of only #constant for precompiler constants, allows certain preqcc using mods to compile"},
