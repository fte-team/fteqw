...
FTE_VECTOR(2,pvec_t,FTE_ALIGN_ADAPTIVE,,pvec,_t);
FTE_VECTOR(3,pvec_t,FTE_ALIGN_ADAPTIVE,,pvec,_t);
FTE_VECTOR(4,pvec_t,FTE_ALIGN_ADAPTIVE,,pvec,_t);
FTE_VECTOR(5,pvec_t,FTE_ALIGN_ADAPTIVE,,pvec,_t);
FTE_VECTOR(6,pvec_t,FTE_ALIGN_ADAPTIVE,,pvec,_t);
FTE_VECTOR(7,pvec_t,FTE_ALIGN_ADAPTIVE,,pvec,_t);
FTE_VECTOR(8,pvec_t,FTE_ALIGN_ADAPTIVE,,pvec,_t);
...
void		QDECL VectorAngles (const vec_t *forward, const vec_t *up, vec_t *angles, qboolean meshpitch); /* up maybe NULL */
